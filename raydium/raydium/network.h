...
// do the minimal reg_api job (this should not be done like this ! :/)
// part 2
raydium_register_function((void*)(C2PHP(raydium_parser_db_get)),"raydium_parser_db_get");
raydium_register_function((void*)(C2PHP(raydium_file_home_path_cpy)),"raydium_file_home_path_cpy");
...
void raydium_network_only_init_port(int argc, char **argv)
{
setbuf(stdout,NULL);
signal(SIGINT,raydium_network_only_quit);
raydium_init_args(argc,argv);
...
raydium_network_server_create_port(port);
}
