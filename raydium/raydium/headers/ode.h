...
__rayapi signed char raydium_ode_element_rotm_get_name (char *e, dReal* mat);
/**
Same as above, but using element's name.
**/

__rayapi signed char raydium_ode_element_rot_forward_get (int e, dReal *dx, dReal *dy, dReal *dz);
/**
得到旋转矩阵forward方向
**/

__rayapi signed char raydium_ode_element_rot_forward_get_name (char *e, dReal *dx, dReal *dy, dReal *dz);
/**
Same as above, but using element's name.
**/
