...
//    raydium_web_body_default=index_text;
    ...
    // Ugly hack, for now...
    raydium_network_netcall_add(wrong_msg,RAYDIUM_NETWORK_PACKET_ODE_EXPLOSION,1);
    raydium_network_netcall_add(wrong_msg,RAYDIUM_NETWORK_PACKET_ODE_NEWELEM,1);
    raydium_network_netcall_add(wrong_msg,RAYDIUM_NETWORK_PACKET_ODE_REMELEM,1);
    raydium_network_netcall_add(wrong_msg,RAYDIUM_NETWORK_PACKET_ODE_NIDWHO,1);
    raydium_network_netcall_add(wrong_msg,NET_SCORE_TRACK,1);
    raydium_network_netcall_add(wrong_msg,NET_RESTART,1);

    raydium_network_on_connect = create_collect_server;
