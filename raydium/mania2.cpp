...
static char *version="0.41";
static char *title="CQFD Corp. Mania2";
...
void gui_exit(void)
{
    ...
    raydium_gui_button_create("btnExitOk",handle,20,15,"OK",(void*)btnExitOk);
    raydium_gui_button_create("btnExitCancel",handle,50,15,"Cancel",(void*)btnExitCancel);
...
void build_gui_clear(raydium_gui_Object *w)
{
    ...
    raydium_gui_widget_sizes(15,5,18);
    raydium_gui_button_create("btnClearOk",handle,20,15,"OK",(void*)btnClearOk);
    raydium_gui_button_create("btnClearCancel",handle,50,15,"Cancel",(void*)btnClearCancel);
...
void build_gui_help(raydium_gui_Object *w)
{
    ...
    raydium_gui_button_create("btnOk",handle,45,3,"OK",(void*)build_gui_menu);
...
void build_gui_meta(raydium_gui_Object *w)
{
    ...
    raydium_gui_widget_sizes(10,3,14);
    raydium_gui_button_create("btnLoad",handle,70,8,"OK",(void*)btnMetaOk);
    raydium_gui_button_create("btnCancel",handle,85,8,"cancel",(void*)build_gui_menu);
}
...
void build_gui_load(raydium_gui_Object *w)
{
    ...
    raydium_gui_widget_sizes(10,3,14);
    raydium_gui_button_create("btnLoad",handle,20,20,"load",(void*)btnLoad);
    raydium_gui_button_create("btnCancel",handle,60,20,"cancel",(void*)build_gui_menu);
...
void build_gui_save(raydium_gui_Object *w)
{
    ...
    raydium_gui_widget_sizes(10,3,14);
    raydium_gui_button_create("btnSave",handle,20,20,"save",(void*)btnSave);
    raydium_gui_button_create("btnCancel",handle,60,20,"cancel",(void*)build_gui_menu);
...
void build_gui_menu(raydium_gui_Object *w)
{
    ...
    raydium_gui_button_create("btnLoad",handle,10,y-=YDEC,"load",(void*)build_gui_load);
    raydium_gui_button_create("btnSave",handle,10,y-=YDEC,"save",(void*)build_gui_save);
    raydium_gui_button_create("btnClear",handle,10,y-=YDEC,"clear all",(void*)build_gui_clear);
    raydium_gui_button_create("btnEdit",handle,10,y-=YDEC,"edit infos",(void*)build_gui_meta);
    raydium_gui_button_create("btnTest",handle,10,y-=YDEC,"test track",(void*)btnTest);
    raydium_gui_button_create("btnHelp",handle,10,y-=YDEC,"key help",(void*)build_gui_help);
    raydium_gui_button_create("btnClose",handle,10,y-=YDEC,"close menu",(void*)build_gui_access);

    raydium_gui_button_create("btnExit",handle,10,y-=(YDEC*2),"exit",(void*)btnExit);
}
...
void build_gui_access(raydium_gui_Object *w)
{
    ...
    raydium_gui_button_create("btnMenu",handle,18,15,"menu",(void*)build_gui_menu);
}
...
void draw_box(float x,float y,float z,float ox, float oy, float oz, float tx,float ty,float tz,int type)
{
    ...
    case TYPE_TURBO_S:
        ...
        break;
    //绘制赛道判别模块
    case TRACK_TYPE_STRAIGHT:       //直道
        glColor3f(0, 0.5f, 0);
        break;
    case TRACK_TYPE_CROOK:          //弯道
        glColor3f(0.5f, 0, 0);
        break;
    case TRACK_TYPE_BUMP:           //颠簸
        glColor3f(0.5f, 0.5f, 0);
        break;
    case TRACK_TYPE_UPWARD:         //上升
        glColor3f(0, 0.5f, 0.5f);
        break;
    case TRACK_TYPE_DOWNWARD:       //下降
        glColor3f(0.5f, 0, 0.5f);
        break;
    case TRACK_TYPE_SPRING:         //跳板
        glColor3f(0, 0, 0.5f);
        break;
    } // end switch
...
// if(raydium_key_last==2) export_all();
        ...
        else if(raydium_key_last==1013 && pop_mode==POP_MODE_BOX) pop_mode=POP_MODE_ELEM;
