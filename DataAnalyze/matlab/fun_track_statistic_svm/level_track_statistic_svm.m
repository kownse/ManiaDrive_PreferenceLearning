function level_track_statistic_svm
clear;
clc;
tic;
...
%{
%用归类的数据训练
load 'G:\game\maniadrive\ManiaDrive_Custom\数据分析\matlab\fun_track_statistic_svm\fun_t_s_classed.mat';
level_track_mat = fun_track_statistic_mat;
[m,n] = size(level_track_mat);
...
model = svmtrain(train_level_label,train_level_scale, ' -v 5 -c 2 -g 1 -t 3');
